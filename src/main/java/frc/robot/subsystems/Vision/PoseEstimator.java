...
public class PoseEstimator extends SubsystemBase {
  ...
  public void periodic() {
    ...
    if (VisionConfig.IS_PHOTON_VISION_MODE) { // Limelight mode
    ...
    if (VisionConfig.VISION_OVERRIDE_ENABLED) {
      drivetrain.setPose(getPosition());
    }
  ...
  public void resetPoseEstimate(Pose2d poseMeters) {
    ...
    drivetrain.setPose(poseMeters);
  }

  public void resetHeading(Rotation2d angle) {
    drivetrain.setPose(new Pose2d(drivetrain.getPose().getTranslation(), angle));
